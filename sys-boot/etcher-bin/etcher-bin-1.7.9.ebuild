...
src_install() {
	...
	sed -i "s/Exec=\/opt\/balenaEtcher\/balena-etcher-electron %U/Exec=\/opt\/balenaEtcher\/balena-etcher-electron --no-sandbox %U/g" "${D}/usr/share/applications/balena-etcher-electron.desktop"
